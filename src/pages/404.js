...
import Astronaut from '../constants/AstronautIcon'
...
const NotFoundPage = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <meta httpEquiv='refresh' content=' 10, url= https://resume-of-elalfy.netlify.app' />
      </Helmet>
      <main className="container">
        <div className="notfound">
          ...
          <div className="notfound_info self-center">
            ...
            How you got here is a mystery.  But you can wait {counter} second and it will Home page
        </p>
